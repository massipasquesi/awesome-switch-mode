...
globalkeys = awful.util.table.join(
    ...
    -- mise en veille, hibernate, shutdown, restart --
    -- suspend
    awful.key({ modkey, "Control" }, "s", function () awful.util.spawn(awful.util.getdir("config") .. "/scripts/suspend.sh") end),
    -- shutdown
    awful.key({ modkey, "Control" }, "Delete", function () awful.util.spawn(awful.util.getdir("config") .. "/scripts/shutdown.sh") end),
    -- menu
    awful.key({ modkey, "Control" }, "Escape", function () awful.util.spawn(awful.util.getdir("config") .. "/scripts/IO-dialogue.sh") end),


    -- xrandr tools
    -- for the moment the script can be run only in terminal
    -- awful.key({ modkey, "Control" }, "x", function () awful.util.spawn(awful.util.getdir("config") .. "/scripts/adjust-2screen.sh") end),
    ...
    -- version amixer commune for MUTE
    --awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer set Master toggle", false) end)
    -- version ubuntu testing
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("amixer -q -D default sset Master 10%+", false) end),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer -q -D default sset Master 10%-", false) end),
    awful.key({ }, "XF86AudioMute", function () awful.util.spawn("amixer -q -D default sset Master toggle", false) end)
)
...
-- {{ includes applets & others personalisations

-- conky ( ça marche pas pour l'instant )
